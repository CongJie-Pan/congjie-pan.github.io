...
window.translations = {
  'en': {
    ...
    'exp-iceet-2026-note': 'Note: Official conference proceedings have been published in July 2026',
    'exp-iceet-2026-paper': 'Paper',
  ...
  'zh-TW': {
    ...
    'exp-iceet-2026-note': '備註：大會正式電子論文集已於 2026 年 7 月歸檔出版',
    'exp-iceet-2026-paper': '論文',
    ...
    'proj-ticket-demo': '示範影片',
    
    'proj-foodie-title': '零食販售網站：Foodie',
    'proj-foodie-desc': '領導團隊開發專注於販售韓式零食的前端網站，包括泡麵、飲料和糖果。網站具有溫暖的土色調設計和使用者友善的介面，提供直觀的購物體驗。',
    'proj-foodie-doc': '文件',
    'proj-foodie-code': '程式碼',
    'proj-foodie-demo': '前端網站示範',
  ...
  'zh-CN': {
    ...
    'exp-iceet-2026-note': '备注：大会正式电子论文集已于 2026 年 7 月归档出版',
    'exp-iceet-2026-paper': '论文',
    ...
    'exp-ape-period': '2022年9月 – 2023年9月',
    'exp-ape-role': '讲师',
    'exp-ape-desc': '一年的时间教授小学生Scratch、Minecraft Education和App Inventor。同时也开发Minecraft Edu的课程计划。',
    
    'exp-tutor-title': '暑期程序家教',
    'exp-tutor-period': '2022年7月 – 2022年8月',
    'exp-tutor-role': '远程家教',
    ...
    'proj-ticket-title': '超速罚单管理系统',
    'proj-ticket-desc': '主导系统分析、协调任务，并确保超速罚单管理系统的成功完成。该项目与台北市仪表板整合，提升数据分析效率。',
    'proj-ticket-doc': '文档',
    'proj-ticket-code': '代码',
    'proj-ticket-demo': '演示视频',
    
    'proj-foodie-title': '零食销售网站：Foodie',
    'proj-foodie-desc': '领导团队开发专注于销售韩式零食的前端网站，包括泡面、饮料和糖果。网站具有温暖的土色调设计和用户友好的界面，提供直观的购物体验。',
    'proj-foodie-doc': '文档',
    'proj-foodie-code': '代码',
    'proj-foodie-demo': '前端网站演示',
